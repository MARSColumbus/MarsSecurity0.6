...
class gsp_MarsSecurityindex_gsp extends org.grails.gsp.GroovyPage {
...
invokeTag('captureContent','sitemesh',36,['tag':("nav")],2)
printHtmlPart(16)
invokeTag('image','asset',37,['src':("grails-cupsonly-logo-white.svg"),'class':("grails-logo")],-1)
printHtmlPart(17)
...
invokeTag('link','g',59,['controller':(c.logicalPropertyName)],3)
printHtmlPart(19)
}
printHtmlPart(20)
})
...
public static final long LAST_MODIFIED = 1733103610418L
